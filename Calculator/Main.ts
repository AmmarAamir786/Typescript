...
switch (calculator.Operation) {
  ...
  case chalk.blue("Subtraction"):
    console.log(
      `Your result ${Subtract(calculator.Number1, calculator.Number2)}`
    );
    break;
  case chalk.green("Multiplication"):
    console.log(
      `Your result ${Multiply(calculator.Number1, calculator.Number2)}`
    );
    break;
  case chalk.yellow("Division"):
    console.log(
      `Your result ${Divide(calculator.Number1, calculator.Number2)}`
    );
    break;
}
